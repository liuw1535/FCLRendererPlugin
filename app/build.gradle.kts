...
android {
    ...
    buildTypes {
        ...
        configureEach {
            //应用名
            //app name
            resValue("string","app_name","SimpleFPE Renderer")
            //包名后缀
            //package name Suffix
            applicationIdSuffix = ".simplefpe"

            //渲染器在启动器内显示的名称
            //The name displayed by the renderer in the launcher
            manifestPlaceholders["des"] = "SimpleFPE"
            ...
            manifestPlaceholders["renderer"] = "SimpleFPE:libSimpleFPEWrapper.so:libSimpleFPEWrapper.so"
